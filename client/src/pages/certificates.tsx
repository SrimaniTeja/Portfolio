  ...
  const certificates = [
    {
      ...
      provider: "Coursera",
      file: "/attached_assets/Coursera_1753725836629.pdf",
    ...
    },
    {
      ...
      file: "/public/attached_assets/ApoorvCTF-Certificate_1753725836628.pdf",
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-dark/95 backdrop-blur-md border-b border-electric/20">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-xl font-bold text-neon-green">SE</div>
          </div>
        </div>
      </nav>
